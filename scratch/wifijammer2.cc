...
main(int argc, char* argv[])
{
    ...
    extraCsmaNodes.Create(3);

    NodeContainer csmaNodes;
    csmaNodes.Add(p2pNodes.Get(1));
    csmaNodes.Add(extraCsmaNodes);
    ...
    // std::cout << "wifiApNode tamanho: " << wifiApNode.GetN() << std::endl;
    // std::cout << "wifiStaNodes tamanho: " << wifiStaNodes.GetN() << std::endl;
    // std::cout << "csmaNodes tamanho: " << csmaNodes.GetN() << std::endl;

    stack.Install(p2pNodes);
    stack.Install(extraCsmaNodes);
   // stack.Install(csmaNodes);
    ...
    ApplicationContainer serverApps = echoServer.Install(extraCsmaNodes.Get(2)); // Era csmaNodes.Get(3)
